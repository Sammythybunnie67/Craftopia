...
@Mod("ctp")
public class CtpMod {
	public static final Logger LOGGER = LogManager.getLogger(CtpMod.class);
	public static final String MODID = "ctp";
	...
	public CtpMod() {
		...
		CtpModBlocks.REGISTRY.register(bus);
		CtpModItems.REGISTRY.register(bus);

		CtpModBlockEntities.REGISTRY.register(bus);
